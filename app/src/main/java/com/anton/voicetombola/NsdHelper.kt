...
class NsdHelper(private val context: Context) {
    ...
    fun isCallerActive(code: String, callback: (String?) -> Unit) {
        ...
        // Timeout after 6 seconds if nothing found
